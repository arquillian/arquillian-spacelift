...
public class CommandToolWorkingDirTest {
    ...
    public void testExistingWorkingDir() throws Exception {
        ...
        Spacelift.task(CommandTool.class).workingDir(existingDirectory);
    }
    ...
    public void testExistingWorkingDirectory() throws Exception {
        ...
        Spacelift.task(CommandTool.class).workingDirectory(existingDirectory);
    }
    ...
    public void testNonexistentDirectory() throws Exception {
        ...
        Spacelift.task(CommandTool.class).workingDirectory(nonexistentDirectory);
    }
    ...
    public void testFileAsWorkingDirectory() throws Exception {
        ...
        Spacelift.task(CommandTool.class).workingDirectory(createTempFile().getAbsolutePath());
    }

    @Test
    public void testNullAsWorkingDirectory() throws Exception {
        Spacelift.task(CommandTool.class).workingDir(null);
    }

    @Test
    public void testUserDirAsWorkingDirectory() throws Exception {
        Spacelift.task(CommandTool.class).workingDirectory(CommandTool.CURRENT_USER_DIR);
    }
